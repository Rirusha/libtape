...
public class CassetteClient.Storager: Object {
     ...
     */
    public async void clear_user_data_async (bool keep_content, bool keep_datadir) {
        if (keep_content) {
            yield move_file_dir_async (data_images_dir_file, cache_images_dir_file);
            yield move_file_dir_async (data_objects_dir_file, cache_objects_dir_file);
            yield move_file_dir_async (data_audios_dir_file, cache_audios_dir_file);
        }
    ...
    string replace_many (string input, char[] targets, char replacement) {
    ...
    public async void save_image_async (owned uint8[] image_data, string image_url, bool is_tmp = true) {
     ...
     */
    public async void save_audio_async (owned uint8[] audio_data, string track_id, bool is_tmp) {
    ...
    public async void save_object_async (YaMAPI.HasID yam_object, bool is_tmp) {
