...
namespace CassetteClient {
    ...
    public class Storager : Object {
        ...
        */
        ...
        public YaMAPI.HasTracks[] get_saved_objects () {
        ...
        public YaMAPI.HasID? load_object (Type obj_type, string oid) {
        ...
        public void save_object (YaMAPI.HasID yam_object, bool is_tmp) {
