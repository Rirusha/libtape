...
public sealed class Tape.YaMAPI.YaMClient : Object {
     ...
     *
     */
    public void albums_with_tracks (string album_id,
                                    bool rich_tracks) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public Playlist playlist (string playlist_uuid,
                              bool resume_stream,
                              bool rich_tracks) throws ClientError, BadStatusCodeError {
        var bytes = soup_wrapper.get_sync (
     ...
     *
     */
    public void artists_tracks (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_track_ids (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_safe_direct_albums (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_brief_info (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_similar (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_discography_albums (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_direct_albums (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_also_albums (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void artists_concerts (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void users_playlists_list_kinds (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void users_playlists (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public Gee.ArrayList<Playlist> users_playlists_list (owned string? uid = null) throws ClientError,
    BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public Playlist users_playlists_playlist (string playlist_kind,
                                              bool rich_tracks,
                                              owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public void users_playlists_playlist_change_relative (string playlist_kind,
                                                          owned string? uid = null) throws ClientError,
    BadStatusCodeError {
        check_uid (ref uid);
    }

    public bool users_playlists_delete (owned string? uid,
                                        string kind) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_playlists_change (owned string? uid,
                                            string kind,
                                            string diff,
                                            int revision = 1) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_playlists_create (owned string? uid,
                                            string title,
                                            string visibility = "private") throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_playlists_name (owned string? uid,
                                          string kind,
                                          string new_name) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public PlaylistRecommendations users_playlists_recommendations (owned string? uid,
                                                                    string kind) throws ClientError,
    BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_playlists_visibility (owned string? uid,
                                                string kind,
                                                string visibility) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_palylists_cover_upload (owned string? uid,
                                                  string kind,
                                                  uint[] new_cover,
                                                  string filename,
                                                  string content_type) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Playlist users_palylists_cover_clear (owned string? uid,
                                                 string kind,
                                                 uint[] new_cover) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public void users_likes_albums (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void users_likes_artists (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public Gee.ArrayList<LikedPlaylist> users_likes_playlists (owned string? uid = null) throws ClientError,
    BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public int64 users_likes_tracks_add (string track_id,
                                         owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public int64 users_likes_tracks_remove (string track_id,
                                            owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    ...
    public Gee.ArrayList<TrackShort> users_dislikes_tracks (owned string? uid,
                                                            int if_modified_since_revision = 0) throws ClientError,
    BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public int64 users_dislikes_tracks_add (string track_id,
                                            owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public int64 users_dislikes_tracks_remove (string track_id,
                                               owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_likes_artists_add (string artist_id,
                                         owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_likes_artists_remove (string artist_id,
                                            owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_dislikes_artists_add (string artist_id,
                                            owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_dislikes_artists_remove (string artist_id,
                                               owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_likes_albums_add (string album_id,
                                        owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_likes_albums_remove (string album_id,
                                           owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public bool users_likes_playlists_add (string playlist_uid,
                                           string owner_uid,
     ...
     *
     */
    public bool users_likes_playlists_remove (string playlist_uid,
                                              owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
     ...
     *
     */
    public void users_presaves_add (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void users_presaves_remove (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void users_search_history (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void users_search_history_clear (owned string? uid = null) throws ClientError, BadStatusCodeError {
        check_uid (ref uid);
    }
     ...
     *
     */
    public void metatags_metatag (string metatag) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void metatags_albums (string metatag) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void metatags_artists (string metatag) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void metatags_playlists (string metatag) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void top_category (string category) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void rotor_station_info (string station_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public StationTracks rotor_session_new (SessionNew session_new) throws ClientError, BadStatusCodeError {
     ...
     *
     */
    public StationTracks rotor_session_tracks (string radio_session_id,
                                               Rotor.Queue queue) throws ClientError, BadStatusCodeError {
        PostContent post_content = {
            PostContentType.JSON,
     ...
     *
     */
    public void rotor_session_feedback (string radio_session_id,
                                        Rotor.Feedback feedback) throws ClientError, BadStatusCodeError {
        PostContent post_content = {
            PostContentType.JSON,
     ...
     * @return                      успех выполнения
     */
    public bool plays (Play[] play_objs) throws ClientError, BadStatusCodeError {
     ...
     *
     */
    public void rewind_slides_artist (string artist_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void pins_albums (bool pin) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void pins_playlist (bool pin) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void pins_artist (bool pin) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void pins_wave (bool pin) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void tags_playlist_ids (string tag_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }
     ...
     *
     */
    public void feed_promotions_promo (string promo_id) throws ClientError, BadStatusCodeError {
        assert_not_reached ();
    }

    public Gee.ArrayList<Track> tracks (string[] id_list,
                                        bool with_positions = false) throws ClientError, BadStatusCodeError {
        var datalist = Datalist<string> ();
    ...
    public string ? track_download_uri (string track_id,
                                        bool hq = true) throws ClientError, BadStatusCodeError {
    ...
    public Lyrics track_lyrics (string track_id,
                                bool is_sync) throws ClientError, BadStatusCodeError {
